...
class PadMapper:
    ...
    def get_all_mappings(self):
        ...
        new_config = recursive_default_dict()
    ...
    def request_button(self, button_name):
        pygame.display.set_caption('Press %s' % button_name)
    ...
    def request_stick(self, stick_name):
        ...
        for direction in ('up', 'down', 'left', 'right'):
            pygame.display.set_caption('Move %s %s, then release' % (stick_name,
                                                                     direction))
    ...
    def request_trigger(self, trigger_name):
        pygame.display.set_caption('Pull %s all the way, then release' %
                                   trigger_name)
